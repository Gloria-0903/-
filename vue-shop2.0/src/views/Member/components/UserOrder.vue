...
<script setup lang="ts">
    import type { OrderData } from '@/apis/pay'
    ...
    const getOrderList = async () => {
      //try {
      //  const res = await getUserOrder(params.value) as any
    ...
    const stateMap: Record<number, string | undefined> = {
      1: '待付款',
      2: '待发货',
      3: '待收货',
      4: '待评价',
